...
public class EntityDSLSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case EntityDSLPackage.ABSTRACT_ELEMENT:
      {
      ...
      case EntityDSLPackage.LITERAL:
      {
        ...
        if (result == null) result = caseType(literal);
        if (result == null) result = caseAbstractElement(literal);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EntityDSLPackage.TYPE:
      {
