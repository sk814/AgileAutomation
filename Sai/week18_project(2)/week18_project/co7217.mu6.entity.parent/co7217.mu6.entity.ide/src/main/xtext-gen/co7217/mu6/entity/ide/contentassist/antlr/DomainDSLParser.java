 ...
 */
package co7217.mu6.entity.ide.contentassist.antlr;

import co7217.mu6.entity.ide.contentassist.antlr.internal.InternalDomainDSLParser;
...
public class DomainDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(DomainDSLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DomainDSLGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalDomainDSLParser createParser() {
		InternalDomainDSLParser result = new InternalDomainDSLParser(null);
